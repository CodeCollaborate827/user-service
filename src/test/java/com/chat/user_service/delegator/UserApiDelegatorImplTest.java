...
class UserApiDelegatorImplTest {
  ...
  public void acceptFriendRequest_withValidInput_shouldReturnSuccessResponse() {
    ...
    WebTestClient.ResponseSpec response =
        webTestClient
            .post()
            .uri(ACCEPT_FRIEND_REQUEST_ENDPOINT)
    ...
    response
        ...
        .is2xxSuccessful()
        .expectBody()
        .jsonPath(COMMON_RESPONSE_ERROR_CODE_JSON_PATH)
        .doesNotExist()
        .jsonPath(COMMON_RESPONSE_MESSAGE_JSON_PATH)
        .isEqualTo(getCommonSuccessResponse().getMessage())
        .jsonPath(COMMON_RESPONSE_REQUEST_ID_JSON_PATH)
        .isEqualTo(getCommonSuccessResponse().getRequestId());
  }

  @Test
  public void
      acceptFriendRequest_withValidInputAndWithoutRequestIdHeader_shouldReturnSuccessResponse() {
    // given
    CommonSuccessResponse commonResponse = getCommonSuccessResponse();
  ...
  public void denyFriendRequest_withValidInput_shouldReturnSuccessResponse() {
    ...
    WebTestClient.ResponseSpec response =
        webTestClient
            .post()
            .uri(DENY_FRIEND_REQUEST_ENDPOINT)
            .contentType(APPLICATION_JSON)
            .accept(APPLICATION_JSON)
  ...
  @Test
  public void
      denyFriendRequest_withValidInputAndWithoutRequestIdHeader_shouldReturnSuccessResponse() {
    // given
    CommonSuccessResponse commonResponseMono = getCommonSuccessResponse();
    when(friendshipService.denyFriendRequest(any(), any(), any()))
        .thenReturn(Mono.just(ResponseEntity.ok(commonResponseMono)));
  ...
  public void getUserFriendRequests_withValidInput_shouldReturnSuccessResponse() {
    // given
    FriendRequestListPagingResponse friendRequestListPagingResponse =
        getFriendRequestListPagingResponse();
    ...
    WebTestClient.ResponseSpec response =
        webTestClient
            .get()
            .uri(GET_FRIEND_REQUESTS_ENDPOINT.formatted(5, 1))
            .accept(APPLICATION_JSON)
            .headers(setUserIdAndRequestIdInRequestHeader())
            .exchange();
    ...
    response
        ...
        .jsonPath(COMMON_RESPONSE_ERROR_CODE_JSON_PATH)
        .doesNotExist()
        .jsonPath(COMMON_RESPONSE_DATA_JSON_PATH)
        .exists();
  }

  @Test
  public void
      getUserFriendRequests_withValidInputAndWithoutRequestIdHeader_shouldReturnSuccessResponse() {
    // given
    FriendRequestListPagingResponse friendRequestListPagingResponse =
        getFriendRequestListPagingResponse();
    when(friendshipService.getUserFriendRequests(any(), any(), anyInt(), anyInt()))
  ...
  @Test
  public void
      getUserFriendRequests_withValidInputAndWithoutUserIdHeader_shouldReturnBadRequestResponse() {
    // given
    FriendRequestListPagingResponse friendRequestListPagingResponse =
        getFriendRequestListPagingResponse();
    when(friendshipService.getUserFriendRequests(any(), any(), anyInt(), anyInt()))
  ...
  public void getUserFriends_withValidInput_shouldReturnSuccessResponse() {
    ...
    WebTestClient.ResponseSpec response =
        webTestClient
            .get()
            .uri(GET_FRIEND_LIST_ENDPOINT.formatted(5, 1))
            .headers(setUserIdAndRequestIdInRequestHeader())
            .accept(APPLICATION_JSON)
            .exchange();
  ...
  public void sendFriendRequest_withValidInput_shouldReturnSuccessResponse() {
    ...
    WebTestClient.ResponseSpec response =
        webTestClient
            .post()
            .uri(ADD_FRIEND_REQUEST_ENDPOINT)
            .contentType(APPLICATION_JSON)
            .accept(APPLICATION_JSON)
            .headers(setUserIdAndRequestIdInRequestHeader())
  ...
  @Test
  public void
      sendFriendRequest_withValidInputAndWithoutRequestIdHeader_shouldReturnSuccessResponse() {
    CommonSuccessResponse commonSuccessResponse = getCommonSuccessResponse();
    when(friendshipService.sendFriendRequest(any(), any(), any(Mono.class)))
        .thenReturn(Mono.just(ResponseEntity.ok((commonSuccessResponse))));
  ...
  @Test
  public void
      sendFriendRequest_withValidInputAndWithoutUserIdHeader_shouldReturnBadRequestResponse() {
    // when
    AddFriendRequest addFriendRequest = getAddFriendRequest();
    WebTestClient.ResponseSpec response =
        webTestClient
  ...
  @Test
  public void
      updateUserProfile_withValidInputAndWithoutRequestIdHeader_shouldReturnSuccessResponse() {
    CommonSuccessResponse commonSuccessResponse = getCommonSuccessResponse();
    when(userService.updateUserProfile(any(), any(), any(Mono.class)))
        .thenReturn(Mono.just(ResponseEntity.ok((commonSuccessResponse))));
  ...
  @Test
  public void
      updateUserProfile_withValidInputAndWithoutUserIdHeader_shouldReturnBadRequestResponse() {
    // when
    UpdateProfileRequest updateProfileRequest = getUpdateProfileRequest();
    WebTestClient.ResponseSpec response =
        webTestClient
  ...
  @Test
  public void
      updateUserProfileImage_withValidInputAndWithoutRequestIdHeader_shouldReturnSuccessResponse() {
    // given
    CommonSuccessResponse commonSuccessResponse = getCommonSuccessResponse();
    when(userService.updateUserProfileImage(any(), any(), any(Flux.class)))
        .thenReturn(Mono.just(ResponseEntity.ok(commonSuccessResponse)));
  ...
  @Test
  public void
      updateUserProfileImage_withValidInputAndWithoutUserIdHeader_shouldReturnBadRequestResponse() {
    MultipartBodyBuilder multipartBodyBuilder = new MultipartBodyBuilder();
