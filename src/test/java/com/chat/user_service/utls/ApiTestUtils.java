...
public class ApiTestUtils {
  ...
  public static final String ACCEPT_FRIEND_REQUEST_ENDPOINT =
      "/api/user/friends/accept-friend-request";
  public static final String DENY_FRIEND_REQUEST_ENDPOINT = "/api/user/friends/deny-friend-request";
  public static final String GET_FRIEND_REQUESTS_ENDPOINT =
      "/api/user/friends/friend-requests?pageSize=%d&currentPage=%d";
  public static final String GET_FRIEND_LIST_ENDPOINT =
      "/api/user/friends?pageSize=%d&currentPage=%d";
  ...
  public static Consumer<HttpHeaders> setUserIdAndRequestIdInRequestHeader() {
    return httpHeaders -> {
      setUserIdInRequestHeader().andThen(setRequestIdInRequestHeader()).accept(httpHeaders);
    };
  }
